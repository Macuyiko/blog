...
- It would still be useful to construct a very simple model using only a handful of features. This might increase the general "deployability" of the model
- Speaking of deployability: I'm not one to "spend 80% of time getting the final 20% of the work finished up," so I'm not really thinking about building a beautiful moving trendline kind of overlay for OBS, even although I'd love to see a predictive being used in e-sports casting similar as is being done on poker channels, for instance
